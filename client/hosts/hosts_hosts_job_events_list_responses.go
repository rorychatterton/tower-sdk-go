...
func (o *HostsHostsJobEventsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewHostsHostsJobEventsListOK()
...
func NewHostsHostsJobEventsListOK() *HostsHostsJobEventsListOK {
	return &HostsHostsJobEventsListOK{}
}
...
func (o *HostsHostsJobEventsListOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/hosts/{id}/job_events/][%d] hostsHostsJobEventsListOK ", 200)
}

func (o *HostsHostsJobEventsListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
