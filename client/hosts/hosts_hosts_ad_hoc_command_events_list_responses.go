...
func (o *HostsHostsAdHocCommandEventsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewHostsHostsAdHocCommandEventsListOK()
...
func NewHostsHostsAdHocCommandEventsListOK() *HostsHostsAdHocCommandEventsListOK {
	return &HostsHostsAdHocCommandEventsListOK{}
}
...
func (o *HostsHostsAdHocCommandEventsListOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/hosts/{id}/ad_hoc_command_events/][%d] hostsHostsAdHocCommandEventsListOK ", 200)
}

func (o *HostsHostsAdHocCommandEventsListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
