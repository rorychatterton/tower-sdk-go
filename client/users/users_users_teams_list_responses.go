...
func (o *UsersUsersTeamsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUsersUsersTeamsListOK()
...
func (o *UsersUsersTeamsListOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/users/{id}/teams/][%d] usersUsersTeamsListOK ", 200)
}

func (o *UsersUsersTeamsListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
