...
// NewTeamsTeamsUsersListParams creates a new TeamsTeamsUsersListParams object
// with the default values initialized.
func NewTeamsTeamsUsersListParams() *TeamsTeamsUsersListParams {
	var ()
	return &TeamsTeamsUsersListParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewTeamsTeamsUsersListParamsWithTimeout creates a new TeamsTeamsUsersListParams object
...
// NewTeamsTeamsUsersListParamsWithContext creates a new TeamsTeamsUsersListParams object
...
// NewTeamsTeamsUsersListParamsWithHTTPClient creates a new TeamsTeamsUsersListParams object
...
/*TeamsTeamsUsersListParams contains all the parameters to send to the API endpoint
for the teams teams users list operation typically these are written to a http.Request
*/
...
func (o *TeamsTeamsUsersListParams) WithTimeout(timeout time.Duration) *TeamsTeamsUsersListParams {
...
func (o *TeamsTeamsUsersListParams) WithContext(ctx context.Context) *TeamsTeamsUsersListParams {
	o.SetContext(ctx)
	return o
}
...
func (o *TeamsTeamsUsersListParams) WithID(id string) *TeamsTeamsUsersListParams {
	o.SetID(id)
	return o
}
...
func (o *TeamsTeamsUsersListParams) WithPage(page *int64) *TeamsTeamsUsersListParams {
	o.SetPage(page)
	return o
}
...
func (o *TeamsTeamsUsersListParams) WithSearch(search *string) *TeamsTeamsUsersListParams {
	o.SetSearch(search)
	return o
}
...
func (o *TeamsTeamsUsersListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
