...
func (o *GroupsGroupsAdHocCommandsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		result := NewGroupsGroupsAdHocCommandsCreateCreated()
...
func NewGroupsGroupsAdHocCommandsCreateCreated() *GroupsGroupsAdHocCommandsCreateCreated {
	return &GroupsGroupsAdHocCommandsCreateCreated{}
}
...
func (o *GroupsGroupsAdHocCommandsCreateCreated) Error() string {
	return fmt.Sprintf("[POST /api/v2/groups/{id}/ad_hoc_commands/][%d] groupsGroupsAdHocCommandsCreateCreated ", 201)
}

func (o *GroupsGroupsAdHocCommandsCreateCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	return nil
}

/*GroupsGroupsAdHocCommandsCreateBody groups groups ad hoc commands create body
swagger:model GroupsGroupsAdHocCommandsCreateBody
*/
...
func (o *GroupsGroupsAdHocCommandsCreateBody) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (o *GroupsGroupsAdHocCommandsCreateBody) UnmarshalBinary(b []byte) error {
	var res GroupsGroupsAdHocCommandsCreateBody
