...
// NewGroupsGroupsInventorySourcesListParams creates a new GroupsGroupsInventorySourcesListParams object
// with the default values initialized.
func NewGroupsGroupsInventorySourcesListParams() *GroupsGroupsInventorySourcesListParams {
	var ()
	return &GroupsGroupsInventorySourcesListParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGroupsGroupsInventorySourcesListParamsWithTimeout creates a new GroupsGroupsInventorySourcesListParams object
...
// NewGroupsGroupsInventorySourcesListParamsWithContext creates a new GroupsGroupsInventorySourcesListParams object
...
// NewGroupsGroupsInventorySourcesListParamsWithHTTPClient creates a new GroupsGroupsInventorySourcesListParams object
...
/*GroupsGroupsInventorySourcesListParams contains all the parameters to send to the API endpoint
for the groups groups inventory sources list operation typically these are written to a http.Request
*/
...
func (o *GroupsGroupsInventorySourcesListParams) WithTimeout(timeout time.Duration) *GroupsGroupsInventorySourcesListParams {
...
func (o *GroupsGroupsInventorySourcesListParams) WithContext(ctx context.Context) *GroupsGroupsInventorySourcesListParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the groups groups inventory sources list params
func (o *GroupsGroupsInventorySourcesListParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the groups groups inventory sources list params
func (o *GroupsGroupsInventorySourcesListParams) WithHTTPClient(client *http.Client) *GroupsGroupsInventorySourcesListParams {
...
func (o *GroupsGroupsInventorySourcesListParams) WithID(id string) *GroupsGroupsInventorySourcesListParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the groups groups inventory sources list params
func (o *GroupsGroupsInventorySourcesListParams) SetID(id string) {
	o.ID = id
}

// WithPage adds the page to the groups groups inventory sources list params
func (o *GroupsGroupsInventorySourcesListParams) WithPage(page *int64) *GroupsGroupsInventorySourcesListParams {
	o.SetPage(page)
	return o
}

// SetPage adds the page to the groups groups inventory sources list params
func (o *GroupsGroupsInventorySourcesListParams) SetPage(page *int64) {
	o.Page = page
}

// WithPageSize adds the pageSize to the groups groups inventory sources list params
func (o *GroupsGroupsInventorySourcesListParams) WithPageSize(pageSize *int64) *GroupsGroupsInventorySourcesListParams {
...
func (o *GroupsGroupsInventorySourcesListParams) WithSearch(search *string) *GroupsGroupsInventorySourcesListParams {
	o.SetSearch(search)
	return o
}
...
func (o *GroupsGroupsInventorySourcesListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
