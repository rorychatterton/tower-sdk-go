...
func (o *WorkflowApprovalsWorkflowApprovalsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewWorkflowApprovalsWorkflowApprovalsListOK()
...
func NewWorkflowApprovalsWorkflowApprovalsListOK() *WorkflowApprovalsWorkflowApprovalsListOK {
	return &WorkflowApprovalsWorkflowApprovalsListOK{}
}
...
func (o *WorkflowApprovalsWorkflowApprovalsListOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/workflow_approvals/][%d] workflowApprovalsWorkflowApprovalsListOK ", 200)
}

func (o *WorkflowApprovalsWorkflowApprovalsListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
