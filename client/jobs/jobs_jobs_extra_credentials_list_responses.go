...
func (o *JobsJobsExtraCredentialsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewJobsJobsExtraCredentialsListOK()
...
func NewJobsJobsExtraCredentialsListOK() *JobsJobsExtraCredentialsListOK {
	return &JobsJobsExtraCredentialsListOK{}
}
...
func (o *JobsJobsExtraCredentialsListOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/jobs/{id}/extra_credentials/][%d] jobsJobsExtraCredentialsListOK ", 200)
}

func (o *JobsJobsExtraCredentialsListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
