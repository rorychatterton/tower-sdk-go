...
func (o *JobsJobsCredentialsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewJobsJobsCredentialsListOK()
...
func NewJobsJobsCredentialsListOK() *JobsJobsCredentialsListOK {
	return &JobsJobsCredentialsListOK{}
}
...
func (o *JobsJobsCredentialsListOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/jobs/{id}/credentials/][%d] jobsJobsCredentialsListOK ", 200)
}

func (o *JobsJobsCredentialsListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
