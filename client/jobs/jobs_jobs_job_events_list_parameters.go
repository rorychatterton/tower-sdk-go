...
// NewJobsJobsJobEventsListParams creates a new JobsJobsJobEventsListParams object
// with the default values initialized.
func NewJobsJobsJobEventsListParams() *JobsJobsJobEventsListParams {
	var ()
	return &JobsJobsJobEventsListParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewJobsJobsJobEventsListParamsWithTimeout creates a new JobsJobsJobEventsListParams object
...
// NewJobsJobsJobEventsListParamsWithContext creates a new JobsJobsJobEventsListParams object
...
// NewJobsJobsJobEventsListParamsWithHTTPClient creates a new JobsJobsJobEventsListParams object
...
/*JobsJobsJobEventsListParams contains all the parameters to send to the API endpoint
for the jobs jobs job events list operation typically these are written to a http.Request
*/
...
func (o *JobsJobsJobEventsListParams) WithTimeout(timeout time.Duration) *JobsJobsJobEventsListParams {
...
func (o *JobsJobsJobEventsListParams) WithContext(ctx context.Context) *JobsJobsJobEventsListParams {
	o.SetContext(ctx)
	return o
}
...
func (o *JobsJobsJobEventsListParams) WithHTTPClient(client *http.Client) *JobsJobsJobEventsListParams {
...
func (o *JobsJobsJobEventsListParams) WithID(id string) *JobsJobsJobEventsListParams {
	o.SetID(id)
	return o
}
...
func (o *JobsJobsJobEventsListParams) WithPage(page *int64) *JobsJobsJobEventsListParams {
	o.SetPage(page)
	return o
}
...
func (o *JobsJobsJobEventsListParams) WithPageSize(pageSize *int64) *JobsJobsJobEventsListParams {
...
func (o *JobsJobsJobEventsListParams) WithSearch(search *string) *JobsJobsJobEventsListParams {
	o.SetSearch(search)
	return o
}
...
func (o *JobsJobsJobEventsListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
