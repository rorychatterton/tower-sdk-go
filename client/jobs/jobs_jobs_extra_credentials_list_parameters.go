...
// NewJobsJobsExtraCredentialsListParams creates a new JobsJobsExtraCredentialsListParams object
// with the default values initialized.
func NewJobsJobsExtraCredentialsListParams() *JobsJobsExtraCredentialsListParams {
	var ()
	return &JobsJobsExtraCredentialsListParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewJobsJobsExtraCredentialsListParamsWithTimeout creates a new JobsJobsExtraCredentialsListParams object
...
// NewJobsJobsExtraCredentialsListParamsWithContext creates a new JobsJobsExtraCredentialsListParams object
...
// NewJobsJobsExtraCredentialsListParamsWithHTTPClient creates a new JobsJobsExtraCredentialsListParams object
...
/*JobsJobsExtraCredentialsListParams contains all the parameters to send to the API endpoint
for the jobs jobs extra credentials list operation typically these are written to a http.Request
*/
...
func (o *JobsJobsExtraCredentialsListParams) WithTimeout(timeout time.Duration) *JobsJobsExtraCredentialsListParams {
...
func (o *JobsJobsExtraCredentialsListParams) WithContext(ctx context.Context) *JobsJobsExtraCredentialsListParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the jobs jobs extra credentials list params
func (o *JobsJobsExtraCredentialsListParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the jobs jobs extra credentials list params
func (o *JobsJobsExtraCredentialsListParams) WithHTTPClient(client *http.Client) *JobsJobsExtraCredentialsListParams {
...
func (o *JobsJobsExtraCredentialsListParams) WithID(id string) *JobsJobsExtraCredentialsListParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the jobs jobs extra credentials list params
func (o *JobsJobsExtraCredentialsListParams) SetID(id string) {
	o.ID = id
}

// WithPage adds the page to the jobs jobs extra credentials list params
func (o *JobsJobsExtraCredentialsListParams) WithPage(page *int64) *JobsJobsExtraCredentialsListParams {
	o.SetPage(page)
	return o
}
...
func (o *JobsJobsExtraCredentialsListParams) WithPageSize(pageSize *int64) *JobsJobsExtraCredentialsListParams {
...
func (o *JobsJobsExtraCredentialsListParams) WithSearch(search *string) *JobsJobsExtraCredentialsListParams {
	o.SetSearch(search)
	return o
}
...
func (o *JobsJobsExtraCredentialsListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
