...
// NewOrganizationsOrganizationsListParams creates a new OrganizationsOrganizationsListParams object
// with the default values initialized.
func NewOrganizationsOrganizationsListParams() *OrganizationsOrganizationsListParams {
	var ()
	return &OrganizationsOrganizationsListParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewOrganizationsOrganizationsListParamsWithTimeout creates a new OrganizationsOrganizationsListParams object
...
// NewOrganizationsOrganizationsListParamsWithContext creates a new OrganizationsOrganizationsListParams object
...
// NewOrganizationsOrganizationsListParamsWithHTTPClient creates a new OrganizationsOrganizationsListParams object
...
/*OrganizationsOrganizationsListParams contains all the parameters to send to the API endpoint
for the organizations organizations list operation typically these are written to a http.Request
*/
...
func (o *OrganizationsOrganizationsListParams) WithTimeout(timeout time.Duration) *OrganizationsOrganizationsListParams {
...
func (o *OrganizationsOrganizationsListParams) WithContext(ctx context.Context) *OrganizationsOrganizationsListParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the organizations organizations list params
func (o *OrganizationsOrganizationsListParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the organizations organizations list params
func (o *OrganizationsOrganizationsListParams) WithHTTPClient(client *http.Client) *OrganizationsOrganizationsListParams {
...
func (o *OrganizationsOrganizationsListParams) WithPage(page *int64) *OrganizationsOrganizationsListParams {
	o.SetPage(page)
	return o
}
...
func (o *OrganizationsOrganizationsListParams) WithPageSize(pageSize *int64) *OrganizationsOrganizationsListParams {
...
func (o *OrganizationsOrganizationsListParams) WithSearch(search *string) *OrganizationsOrganizationsListParams {
	o.SetSearch(search)
	return o
}
...
func (o *OrganizationsOrganizationsListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
