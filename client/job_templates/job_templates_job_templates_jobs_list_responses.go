...
func (o *JobTemplatesJobTemplatesJobsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewJobTemplatesJobTemplatesJobsListOK()
...
func NewJobTemplatesJobTemplatesJobsListOK() *JobTemplatesJobTemplatesJobsListOK {
	return &JobTemplatesJobTemplatesJobsListOK{}
}
...
func (o *JobTemplatesJobTemplatesJobsListOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/job_templates/{id}/jobs/][%d] jobTemplatesJobTemplatesJobsListOK ", 200)
}

func (o *JobTemplatesJobTemplatesJobsListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
