...
func (o *JobTemplatesJobTemplatesActivityStreamListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewJobTemplatesJobTemplatesActivityStreamListOK()
...
func NewJobTemplatesJobTemplatesActivityStreamListOK() *JobTemplatesJobTemplatesActivityStreamListOK {
	return &JobTemplatesJobTemplatesActivityStreamListOK{}
}
...
func (o *JobTemplatesJobTemplatesActivityStreamListOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/job_templates/{id}/activity_stream/][%d] jobTemplatesJobTemplatesActivityStreamListOK ", 200)
}

func (o *JobTemplatesJobTemplatesActivityStreamListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
