...
// NewDashboardDashboardGraphsJobsListParams creates a new DashboardDashboardGraphsJobsListParams object
// with the default values initialized.
func NewDashboardDashboardGraphsJobsListParams() *DashboardDashboardGraphsJobsListParams {

	return &DashboardDashboardGraphsJobsListParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewDashboardDashboardGraphsJobsListParamsWithTimeout creates a new DashboardDashboardGraphsJobsListParams object
...
// NewDashboardDashboardGraphsJobsListParamsWithContext creates a new DashboardDashboardGraphsJobsListParams object
...
// NewDashboardDashboardGraphsJobsListParamsWithHTTPClient creates a new DashboardDashboardGraphsJobsListParams object
...
/*DashboardDashboardGraphsJobsListParams contains all the parameters to send to the API endpoint
for the dashboard dashboard graphs jobs list operation typically these are written to a http.Request
*/
