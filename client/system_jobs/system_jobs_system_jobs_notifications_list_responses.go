...
func (o *SystemJobsSystemJobsNotificationsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewSystemJobsSystemJobsNotificationsListOK()
...
func NewSystemJobsSystemJobsNotificationsListOK() *SystemJobsSystemJobsNotificationsListOK {
	return &SystemJobsSystemJobsNotificationsListOK{}
}
...
func (o *SystemJobsSystemJobsNotificationsListOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/system_jobs/{id}/notifications/][%d] systemJobsSystemJobsNotificationsListOK ", 200)
}

func (o *SystemJobsSystemJobsNotificationsListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
