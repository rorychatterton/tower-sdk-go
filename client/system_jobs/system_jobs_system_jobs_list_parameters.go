...
// NewSystemJobsSystemJobsListParams creates a new SystemJobsSystemJobsListParams object
// with the default values initialized.
func NewSystemJobsSystemJobsListParams() *SystemJobsSystemJobsListParams {
	var ()
	return &SystemJobsSystemJobsListParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewSystemJobsSystemJobsListParamsWithTimeout creates a new SystemJobsSystemJobsListParams object
...
// NewSystemJobsSystemJobsListParamsWithContext creates a new SystemJobsSystemJobsListParams object
...
// NewSystemJobsSystemJobsListParamsWithHTTPClient creates a new SystemJobsSystemJobsListParams object
...
/*SystemJobsSystemJobsListParams contains all the parameters to send to the API endpoint
for the system jobs system jobs list operation typically these are written to a http.Request
*/
...
func (o *SystemJobsSystemJobsListParams) WithTimeout(timeout time.Duration) *SystemJobsSystemJobsListParams {
...
func (o *SystemJobsSystemJobsListParams) WithContext(ctx context.Context) *SystemJobsSystemJobsListParams {
	o.SetContext(ctx)
	return o
}
...
func (o *SystemJobsSystemJobsListParams) WithHTTPClient(client *http.Client) *SystemJobsSystemJobsListParams {
...
func (o *SystemJobsSystemJobsListParams) WithPage(page *int64) *SystemJobsSystemJobsListParams {
	o.SetPage(page)
	return o
}
...
func (o *SystemJobsSystemJobsListParams) WithPageSize(pageSize *int64) *SystemJobsSystemJobsListParams {
...
func (o *SystemJobsSystemJobsListParams) WithSearch(search *string) *SystemJobsSystemJobsListParams {
	o.SetSearch(search)
	return o
}
...
func (o *SystemJobsSystemJobsListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
