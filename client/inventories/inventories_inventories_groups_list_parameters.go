...
// NewInventoriesInventoriesGroupsListParams creates a new InventoriesInventoriesGroupsListParams object
// with the default values initialized.
func NewInventoriesInventoriesGroupsListParams() *InventoriesInventoriesGroupsListParams {
	var ()
	return &InventoriesInventoriesGroupsListParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewInventoriesInventoriesGroupsListParamsWithTimeout creates a new InventoriesInventoriesGroupsListParams object
...
// NewInventoriesInventoriesGroupsListParamsWithContext creates a new InventoriesInventoriesGroupsListParams object
...
// NewInventoriesInventoriesGroupsListParamsWithHTTPClient creates a new InventoriesInventoriesGroupsListParams object
...
/*InventoriesInventoriesGroupsListParams contains all the parameters to send to the API endpoint
for the inventories inventories groups list operation typically these are written to a http.Request
*/
...
func (o *InventoriesInventoriesGroupsListParams) WithTimeout(timeout time.Duration) *InventoriesInventoriesGroupsListParams {
...
func (o *InventoriesInventoriesGroupsListParams) WithContext(ctx context.Context) *InventoriesInventoriesGroupsListParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the inventories inventories groups list params
func (o *InventoriesInventoriesGroupsListParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the inventories inventories groups list params
func (o *InventoriesInventoriesGroupsListParams) WithHTTPClient(client *http.Client) *InventoriesInventoriesGroupsListParams {
...
func (o *InventoriesInventoriesGroupsListParams) WithID(id string) *InventoriesInventoriesGroupsListParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the inventories inventories groups list params
func (o *InventoriesInventoriesGroupsListParams) SetID(id string) {
	o.ID = id
}

// WithPage adds the page to the inventories inventories groups list params
func (o *InventoriesInventoriesGroupsListParams) WithPage(page *int64) *InventoriesInventoriesGroupsListParams {
	o.SetPage(page)
	return o
}

// SetPage adds the page to the inventories inventories groups list params
func (o *InventoriesInventoriesGroupsListParams) SetPage(page *int64) {
	o.Page = page
}

// WithPageSize adds the pageSize to the inventories inventories groups list params
func (o *InventoriesInventoriesGroupsListParams) WithPageSize(pageSize *int64) *InventoriesInventoriesGroupsListParams {
...
func (o *InventoriesInventoriesGroupsListParams) WithSearch(search *string) *InventoriesInventoriesGroupsListParams {
	o.SetSearch(search)
	return o
}
...
func (o *InventoriesInventoriesGroupsListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
