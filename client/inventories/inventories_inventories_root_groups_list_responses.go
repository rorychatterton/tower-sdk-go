...
func (o *InventoriesInventoriesRootGroupsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewInventoriesInventoriesRootGroupsListOK()
...
func NewInventoriesInventoriesRootGroupsListOK() *InventoriesInventoriesRootGroupsListOK {
	return &InventoriesInventoriesRootGroupsListOK{}
}
...
func (o *InventoriesInventoriesRootGroupsListOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/inventories/{id}/root_groups/][%d] inventoriesInventoriesRootGroupsListOK ", 200)
}

func (o *InventoriesInventoriesRootGroupsListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
