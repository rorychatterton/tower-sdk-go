...
// NewAuthenticationoListParams creates a new AuthenticationoListParams object
// with the default values initialized.
func NewAuthenticationoListParams() *AuthenticationoListParams {

	return &AuthenticationoListParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewAuthenticationoListParamsWithTimeout creates a new AuthenticationoListParams object
...
// NewAuthenticationoListParamsWithContext creates a new AuthenticationoListParams object
...
// NewAuthenticationoListParamsWithHTTPClient creates a new AuthenticationoListParams object
...
/*AuthenticationoListParams contains all the parameters to send to the API endpoint
for the authentication o list operation typically these are written to a http.Request
*/
...
func (o *AuthenticationoListParams) WithTimeout(timeout time.Duration) *AuthenticationoListParams {
...
func (o *AuthenticationoListParams) WithContext(ctx context.Context) *AuthenticationoListParams {
	o.SetContext(ctx)
	return o
}
...
func (o *AuthenticationoListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
