...
func (o *CredentialTypesCredentialTypesReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCredentialTypesCredentialTypesReadOK()
...
func NewCredentialTypesCredentialTypesReadOK() *CredentialTypesCredentialTypesReadOK {
	return &CredentialTypesCredentialTypesReadOK{}
}
...
func (o *CredentialTypesCredentialTypesReadOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/credential_types/{id}/][%d] credentialTypesCredentialTypesReadOK ", 200)
}

func (o *CredentialTypesCredentialTypesReadOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
