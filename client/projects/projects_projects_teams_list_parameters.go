...
// NewProjectsProjectsTeamsListParams creates a new ProjectsProjectsTeamsListParams object
// with the default values initialized.
func NewProjectsProjectsTeamsListParams() *ProjectsProjectsTeamsListParams {
	var ()
	return &ProjectsProjectsTeamsListParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewProjectsProjectsTeamsListParamsWithTimeout creates a new ProjectsProjectsTeamsListParams object
...
// NewProjectsProjectsTeamsListParamsWithContext creates a new ProjectsProjectsTeamsListParams object
...
// NewProjectsProjectsTeamsListParamsWithHTTPClient creates a new ProjectsProjectsTeamsListParams object
...
/*ProjectsProjectsTeamsListParams contains all the parameters to send to the API endpoint
for the projects projects teams list operation typically these are written to a http.Request
*/
...
func (o *ProjectsProjectsTeamsListParams) WithTimeout(timeout time.Duration) *ProjectsProjectsTeamsListParams {
...
func (o *ProjectsProjectsTeamsListParams) WithContext(ctx context.Context) *ProjectsProjectsTeamsListParams {
	o.SetContext(ctx)
	return o
}
...
func (o *ProjectsProjectsTeamsListParams) WithHTTPClient(client *http.Client) *ProjectsProjectsTeamsListParams {
...
func (o *ProjectsProjectsTeamsListParams) WithID(id string) *ProjectsProjectsTeamsListParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the projects projects teams list params
func (o *ProjectsProjectsTeamsListParams) SetID(id string) {
	o.ID = id
}

// WithPage adds the page to the projects projects teams list params
func (o *ProjectsProjectsTeamsListParams) WithPage(page *int64) *ProjectsProjectsTeamsListParams {
	o.SetPage(page)
	return o
}
...
func (o *ProjectsProjectsTeamsListParams) WithPageSize(pageSize *int64) *ProjectsProjectsTeamsListParams {
...
func (o *ProjectsProjectsTeamsListParams) WithSearch(search *string) *ProjectsProjectsTeamsListParams {
	o.SetSearch(search)
	return o
}
...
func (o *ProjectsProjectsTeamsListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
