...
// NewProjectsProjectsListParams creates a new ProjectsProjectsListParams object
// with the default values initialized.
func NewProjectsProjectsListParams() *ProjectsProjectsListParams {
	var ()
	return &ProjectsProjectsListParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewProjectsProjectsListParamsWithTimeout creates a new ProjectsProjectsListParams object
...
// NewProjectsProjectsListParamsWithContext creates a new ProjectsProjectsListParams object
...
// NewProjectsProjectsListParamsWithHTTPClient creates a new ProjectsProjectsListParams object
...
/*ProjectsProjectsListParams contains all the parameters to send to the API endpoint
for the projects projects list operation typically these are written to a http.Request
*/
...
func (o *ProjectsProjectsListParams) WithTimeout(timeout time.Duration) *ProjectsProjectsListParams {
...
func (o *ProjectsProjectsListParams) WithContext(ctx context.Context) *ProjectsProjectsListParams {
	o.SetContext(ctx)
	return o
}
...
func (o *ProjectsProjectsListParams) WithHTTPClient(client *http.Client) *ProjectsProjectsListParams {
...
func (o *ProjectsProjectsListParams) WithPage(page *int64) *ProjectsProjectsListParams {
	o.SetPage(page)
	return o
}
...
func (o *ProjectsProjectsListParams) WithSearch(search *string) *ProjectsProjectsListParams {
	o.SetSearch(search)
	return o
}
...
func (o *ProjectsProjectsListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
