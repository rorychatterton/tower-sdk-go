...
// NewProjectsProjectsCreateParams creates a new ProjectsProjectsCreateParams object
// with the default values initialized.
func NewProjectsProjectsCreateParams() *ProjectsProjectsCreateParams {
	var ()
	return &ProjectsProjectsCreateParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewProjectsProjectsCreateParamsWithTimeout creates a new ProjectsProjectsCreateParams object
...
// NewProjectsProjectsCreateParamsWithContext creates a new ProjectsProjectsCreateParams object
...
// NewProjectsProjectsCreateParamsWithHTTPClient creates a new ProjectsProjectsCreateParams object
...
/*ProjectsProjectsCreateParams contains all the parameters to send to the API endpoint
for the projects projects create operation typically these are written to a http.Request
*/
...
func (o *ProjectsProjectsCreateParams) WithTimeout(timeout time.Duration) *ProjectsProjectsCreateParams {
...
func (o *ProjectsProjectsCreateParams) WithContext(ctx context.Context) *ProjectsProjectsCreateParams {
	o.SetContext(ctx)
	return o
}
...
func (o *ProjectsProjectsCreateParams) WithHTTPClient(client *http.Client) *ProjectsProjectsCreateParams {
...
func (o *ProjectsProjectsCreateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
