...
func (o *CredentialsCredentialsActivityStreamListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCredentialsCredentialsActivityStreamListOK()
...
func NewCredentialsCredentialsActivityStreamListOK() *CredentialsCredentialsActivityStreamListOK {
	return &CredentialsCredentialsActivityStreamListOK{}
}
...
func (o *CredentialsCredentialsActivityStreamListOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/credentials/{id}/activity_stream/][%d] credentialsCredentialsActivityStreamListOK ", 200)
}

func (o *CredentialsCredentialsActivityStreamListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
